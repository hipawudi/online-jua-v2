...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => organizations.load()), await __temp, __restore();
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/organization.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=organization-0e662966.mjs.map
