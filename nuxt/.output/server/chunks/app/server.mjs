...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-7c29d65e.mjs').then((m) => m.default || m)
  },
  {
    name: "news",
    path: "/news",
...
function directive(variants) {
  ...
  return {
    ...
    getSSRProps(binding, node) {
      ...
      const initial = defu$1((variants == null ? void 0 : variants.initial) || {}, bindingInitial || {});
...
const motion_NSCyL1ZD7X = /* @__PURE__ */ defineNuxtPlugin(
  (nuxtApp) => {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-f9dcb10d.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
