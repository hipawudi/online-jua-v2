<template>
  <div>
    <section class="bg-white py-4 2xl:pl-24 lg:pl-16 pl-0">
      <div class="container mx-auto xl:pl-16 px-4">
        <div class="flex flex-wrap items-center">
          <div class="w-full flex flex-col gap-3">
            <ul class="flex flex-wrap items-center gap-x-3 mb-2 text-red-500">
              <li>
                <a
                  class="flex font-medium text-sm text-coolGray-500 hover:text-coolGray-700"
                  href="/"
                >
                  <svg
                    class="mr-2"
              ...
              <div class="flex gap-3 items-center" v-for="(c, idx) in classes" :key="idx">
                <li>
                  <svg
                    width="6"
                    height="15"
                  ...
                  >
                    <path
                      d="M5.34 0.671999L2.076 14.1H0.732L3.984 0.671999H5.34Z"
                      fill="#BBC3CF"
                    ></path>
                  </svg>
                </li>
            ...
            <h2 class="font-semibold uppercase text-red-500 text-3xl border-b-2 pb-4">
              {{ title }}
            </h2>
          </div>
        </div>
