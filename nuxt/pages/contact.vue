...
<template>
  <div class="">
    <page-header :classes="classes" title="CONTACT"></page-header>
    <section
      class="py-6 bg-white lg:pl-16 2xl:pl-24 pl-0"
      style="
      ...
      <div class="container mx-auto xl:pl-16 px-4">
        ...
        <div class="flex flex-wrap items-center">
          <div class="w-full lg:w-1/2 px-4 mb-14 lg:mb-0">
            ...
            <div class="flex mb-18">
              <div
                class="inline-flex mr-6 items-center justify-center w-12 h-12 bg-red-500 rounded-full"
              >
                <svg
              ...
              <div class="mt-2">
                ...
                <p class="text-lg text-coolGray-500 hover:text-coolGray-600 font-medium">
                  P.O. Box No. 795, Safat, 13008 Kuwait
                </p>
              </div>
            </div>
            <div class="flex">
