          ...
          <div class="flex justify-center w-1/2 md:w-1/3">
            <div class="relative">
              ...
              >
                ...
                ></path></svg
              ><input
                class="w-full md:w-52 h-9 py-1 pl-9 pr-4 text-sm text-coolGray-500 font-medium placeholder-coolGray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-coolGray-200 rounded-lg shadow-xsm"
                type="text"
                placeholder="Search"
              />
            </div>
        ...
        <div class="flex flex-wrap mb-24 lg:mb-16 justify-between items-center">
          <div class="w-full lg:w-1/2 mb-10 lg:mb-0">
            ...
            <p class="text-lg md:text-xl text-coolGray-500 font-medium">
              ...
              insight tools, and scrambling for the right data at the right time.
            </p>
          </div>
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full lg:w-1/2 px-4 mb-14 lg:mb-0">
            <div class="flex mb-18">
              <div
                class="inline-flex mr-6 items-center justify-center w-12 h-12 rounded-full bg-red-500"
              >
                <svg
              ...
              <div class="mt-2">
                <h3
                  class="mb-2 text-2xl md:text-3xl leading-9 text-coolGray-900 font-bold"
                >
                  Email
                </h3>
                <a
                  class="text-lg text-coolGray-500 hover:text-coolGray-600 font-medium"
                  href="mailto:#"
            ...
            <div class="flex mb-18">
              ...
              <div class="mt-2">
                ...
                <p class="text-lg text-coolGray-500 hover:text-coolGray-600 font-medium">
                  965 - 2265349
                </p>
              </div>
            </div>
            <div class="flex">
              ...
              <div class="mt-2">
                <h3
                  class="mb-3 text-2xl md:text-3xl leading-9 text-coolGray-900 font-bold"
                >
                  Socials
                </h3>
