        ...
        <div class="flex flex-wrap items-center">
          <div class="w-full md:w-1/2 px-4 mb-20 lg:mb-0">
            <div class="max-w-md mx-auto">
              ...
              <ul class="mb-8">
                <div class="" v-for="(n, idx) in news.data" :key="idx">
                  <li class="flex items-center mb-4">
                    <img
                      class="mr-3 w-6"
                      :src="'/images/red-number-' + (idx + 1) + '.png'"
                      alt=""
                    /><span class="text-lg font-heading text-gray-500 object-cover">{{
                      n.attributes.title
                    }}</span>
                  </li>
                </div>
          ...
          <div class="w-full md:w-1/2 px-4">
            <div class="relative max-w-max mx-auto">
              ...
              <div class="relative w-full overflow-hidden after:clear-both after:block">
                <div v-for="(n, idx) in news.data" :key="idx">
                  <div
                    ...
                    :class="image_number == idx + 1 ? 'block' : 'hidden'"
              ...
              <form>
                <div class="mb-6">
                  ...
                  <input
                    ...
                    type="email"
                    placeholder="alanzi@jua-president.com"
                  />
                </div>
                <div class="mb-6">
                  <label class="block mb-2 text-gray-800 font-medium leading-6" for=""
