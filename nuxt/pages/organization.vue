                    ...
                    <div class="">
                      ...
                      <a @click="popover(idx)" class="cursor-pointer">
                        <div class="relative flex gap-1">
                          <div
                            class="z-50 top-6 absolute whitespace-normal break-words rounded-lg border border-blue-gray-50 bg-white p-4 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none"
                          ...
                          >
                            <svg
                              ...
                              data-v-inspector="pages/contact.vue:46:17"
                            >
                              <path
                                ...
                                fill="currentColor"
                                data-v-inspector="pages/contact.vue:54:19"
                              ></path>
                            </svg>
                          </div>
                          <div
                            class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-red-500"
                            data-v-inspector="pages/contact.vue:74:15"
                          >
                            <svg
                              class="h-6 text-white"
                              width="16"
                              ...
                              fill="none"
                              xmlns="http://www.w3.org/2000/svg"
                              data-v-inspector="pages/contact.vue:77:17"
                            >
                              <path
                                ...
                                fill="currentColor"
                                data-v-inspector="pages/contact.vue:85:19"
                              ></path>
                            </svg>
                          </div>
                          <div
                            class="flex-initial inline-flex items-center justify-center w-6 h-6 rounded-full bg-red-500"
                            data-v-inspector="pages/contact.vue:74:15"
                          >
                            <svg
